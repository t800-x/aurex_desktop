...
<div class:hidden style:display={displayMode} class="page artistsPage">
  ...
  <div class="splitView">
    ...
    <div
      style="height: 100%; width: 1px; background-color: var(--color-divider);"
    ></div>
