...
<ContextMenu.Root>
  ...
  <ContextMenu.Content>
    <ContextMenu.Item onclick={async () => commands.playTracks(tracks!, 0)}
      >Play</ContextMenu.Item
    >
    <ContextMenu.Item onclick={async () => commands.playListNext(null, tracks)}
      >Play Next</ContextMenu.Item
    >
    <ContextMenu.Item
      onclick={async () => commands.addListToQueue(null, tracks)}
