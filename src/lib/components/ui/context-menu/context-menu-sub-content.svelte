...
<ContextMenuPortal {...portalProps}>
    {#if isOpen}
        ...
        <div
            style="position:fixed;inset:0;z-index:49;pointer-events:{isOpen ? 'all' : 'none'};"
